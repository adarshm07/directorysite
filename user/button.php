        ...
        <div class="modal-dialog">
            <div class="modal-content">
				...
				<div class="container-fluid">
					<h5><center>Firstname: <strong><?php echo $drow['list_title']; ?></strong></center></h5> 
                </div> 
				</div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal"><span class="glyphicon glyphicon-remove"></span> Cancel</button>
                    <a href="delete.php?id=<?php echo $row['list_id']; ?>" class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span> Delete</a>
                </div>
    ...
    <div class="modal fade" id="edit<?php echo $row['list_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
				...
				?>
				<div class="container-fluid">
				<form method="POST" action="edit.php?id=<?php echo $erow['list_id']; ?>">
					<div class="row">
						<div class="col-lg-2">
