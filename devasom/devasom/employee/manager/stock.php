...
<body>
					...
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						<nav>
							<ul class="nav navbar-nav">
								<li><a href="http://localhost/devasom/devasom/employee/manager/leave.php" class="active">Leave</a></li>
								<li><a href="#">Add Pooja </a></li>
								<li><a href="http://localhost/devasom/devasom/employee/manager/collector.php">Dashboard</a></li>
								
								<li><a href="http://localhost/devasom/devasom/">Logout</a></li>
	...
	<br /><br />
		Product catagory:<select name="pcy"><option>temple1</option><option>temple2</option><option>temple3</option><option>temple4</option></select>
	<br /><br />
