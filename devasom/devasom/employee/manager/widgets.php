...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="row">
			<div class="col-md-6">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<p>Fill the details of the product and click submit</p>
			...
			<div class="col-md-6">
				<div class="panel panel-default">
					<div class="panel-heading">Product preview</div>
					<div class="panel-body" id="pnl_body">
					<div style="width:50%;margin-left:25%;">
						<div class="panel panel-default"><center><lable id="prev_name">product name</lable></center></div>
						<div class="panel-body" >
							<div class="form-group">
							<center>
							...
							<div class="form-group">
							<center>
								<lable id="prev_desc">Product description</lable>
							</center>
							</div>
							<div class="form-group">
							<center>
