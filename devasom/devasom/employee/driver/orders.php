										 ...
										 <tr>
											...
											?> 
											    <td>
											    		...
											    		?>
											    		<select name="deliver" style="background-color:transparent;border:none;">
											    		<?php
																$sel = "select * from employee where type='deliver'";
																$resl = mysqli_query($conn, $sel);
																while($rr = mysqli_fetch_array($resl)) {
