...
<body>
					...
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						<nav>
							<ul class="nav navbar-nav">
								...
								<li><a href="http://localhost/bakery%20complete/Bakery21-11-18/">Logout </a></li>
 ...
 $fetchqry = "SELECT image FROM `register` where uname='$logged'";
	...
	?></li><li><a href="view_cart.php"  id="cart-info" title="View Cart">  <span class="glyphicon glyphicon-shopping-cart my-cart-icon"><span class="badge badge-notify my-cart-badge"  style="width:200px; height:25px;"></span></span><?php 
