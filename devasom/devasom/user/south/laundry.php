 ...
 $fetchqry = "SELECT image FROM `register` where uname='$r'";
    ...
    <!-- ##### Hero Area Start ##### -->
     ...
     <br> <br> <br> <br> <br> <br> <br> <br> <br>
       <form method="POST">
       <center><h1>LAUNDRY</h1></center><br>
       <div class="container">
          <table class="table table-responsive table-hover table-condensed">
              ...
              <tr class="danger">
                  <td>Flat number</td>
                  <td><input type="text" name="qw" placeholder="flat no"></td>
              </tr>
              <tr class="info">
                    <td>Mobile number</td>
    ...
    if(isset($_POST['qu']))
{
			...
			$query = mysqli_query($db, "INSERT INTO laundry values('null','".$_POST['qw']."','".$_POST['qe']."','".$_POST['qr']."','".$_POST['qt']."','".$_POST['qy']."')");
			?> 
