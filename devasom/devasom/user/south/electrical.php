              ...
              <tr class="info">
                    ...
                    <tr class="success"> 
                        ...
                        <tr class="danger">
                            ...
                            <tr class="info">
                                ...
                                <td><select name="qy">
                                       <option value="">select</option>
                                        ...
                                        <option value="as soon">as soon</option>
                            ...
                            <tr class="danger"> 
                                 <td>Complaint</td>
                                 <td><textarea rows="5" cols="50" name="qc"></textarea></td>
                             </tr>
                            <tr>
    ...
    if(isset($_POST['qu']))
{
			...
			$query = mysqli_query($db, "INSERT INTO electrical values('null','".$_POST['qw']."','".$_POST['qe']."','".$_POST['qr']."','".$_POST['qt']."','".$_POST['qy']."','".$_POST['qc']."')");
			?> 
