    ...
    <body class="app-ui layout-has-drawer layout-has-fixed-header">
        <div class="app-layout-canvas">
                                    ...
                                    <li class="dropdown dropdown-listfile">
                                        <a href="javascript:void(0)" data-toggle="dropdown">
                                            ...
                                            <?php
                                                ...
                                                define('conString', 'mysqli:host=localhost;dbname=taxi_login');
                                                define('dbUser', 'root');
                                                define('dbPass', '');
                            ...
                            <div class="col-sm-6 col-lg-3">
                                <a class="card" href="javascript:void(0)">
                                    <div class="card-block clearfix">
                                        ...
                                        <p class="h6 text-muted m-t-0 m-b-xs">Total Booking</p>
                                            <p class="h3 m-t-sm m-b-0">
                                                <?php

                                                $connection = mysqli_connect('localhost', 'root', '', 'taxi_login');
                                                $result = mysqli_query($connection, "SELECT  COUNT(*) as count FROM taxi");
			...
			<?php
				...
				$query=mysqli_query($conn,"select * from `taxi` where id='{$_SESSION['user']['user_role']}'");
